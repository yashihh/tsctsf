...
TEST_POOL="TestRegistration|TestGUTIRegistration|TestServiceRequest|TestXnHandover|TestN2Handover|TestDeregistration|TestPDUSessionReleaseRequest|TestPaging|TestNon3GPP|TestAFInfluenceOnTrafficRouting|TestReSynchronisation|TestDuplicateRegistration|TestEAPAKAPrimeAuthentication"
if [[ ! "$1" =~ $TEST_POOL ]]
then
