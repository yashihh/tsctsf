...
TEST_POOL="TestRegistration|TestGUTIRegistration|TestServiceRequest|TestXnHandover|TestN2Handover|TestDeregistration|TestPDUSessionReleaseRequest|TestPDUSessionReleaseAbnormal|TestPaging|TestNon3GPP|TestAFInfluenceOnTrafficRouting|TestReSynchronisation|TestDuplicateRegistration|TestEAPAKAPrimeAuthentication"
if [[ ! "$1" =~ $TEST_POOL ]]
then
...
${EXEC_UPFNS} ./bin/go-upf -c ./config/upfcfg.test.yaml &
sleep 2
